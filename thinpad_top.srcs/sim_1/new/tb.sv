...
module tb;
  ...
  parameter BASE_RAM_INIT_FILE = "D:\\Program Files (x86)\\WeChat Files\\wxid_xw3xbqrtm48822\\FileStorage\\File\\2023-07\\asmcode\\gpio_test.bin"; // BaseRAM 初始化文件，请修改为实际的绝对路�?
